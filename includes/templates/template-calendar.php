...
<div class="bp-meeting-fields-wrap bp-calendar-group-fields-wrap">
	...
	<form id="create_calendar_event" method="POST">
		...
		<input type="submit" class="btn" value="<?php esc_html_e('Create', 'bb-zoom-event-category'); ?>"/>
		<input type="hidden" name="action" value="bbzec_create_event"/>
		<?php wp_nonce_field( 'bbzec_create_event', 'bbzec_create_event_field' ); ?>
	</form>
